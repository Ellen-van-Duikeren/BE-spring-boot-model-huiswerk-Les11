...
UPDATE televisions SET remotecontroller_id = 1001 WHERE id = 1001;
UPDATE televisions SET remotecontroller_id = 1002 WHERE id = 1002;
UPDATE televisions SET remotecontroller_id = 1003 WHERE id = 1003;
